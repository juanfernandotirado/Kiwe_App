<template>
  <div class="wait-list-info-container">
        ...
        <div class="restWaiting"> <b>Waiting Time:</b> 
          <div class="wait" v-if="!popupFiveMinute"> <span class="time">{{ assignWaitTime(grSize,selectedRes) }}</span><span class="min">min</span> </div>
...
export default {
  ...
  methods: {
   ...
   computed:{
    ...
    popupFiveMinute(){
      return this.$store.state.popupFiveMinute
    }
